...
*/
noonEduController.controller('NgSpinnerCtrl', [
  '$element',
  '$attrs',
...
noonDirectives
  .directive('ngSpinner', function() {
    return {
      restrict: 'E',
      controller: 'NgSpinnerCtrl',
      link: function($scope, $element, $attrs, ctrl) {
        var spinnerName = ctrl.init();
        $element.addClass('ng-spinner ng-spinner-' + spinnerName);
